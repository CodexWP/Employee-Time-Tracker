...
class ProjectsTable extends Table
{
    ...
    public function editproject($userid,$post)
    {
    ...
    public function addnewtask($userid,$post)
    {
    ...
    public function edittask($userid,$post)
    {
        $count = $this->find('all')
            ->join([
                't' => [
            ...
            ->where(['Projects.project_id' => $post['project_id'],'Projects.created_userid'=>$userid,'t.id'=>$post['id']])->count();
