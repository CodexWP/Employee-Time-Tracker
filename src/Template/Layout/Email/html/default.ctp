            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;" >
                <tr>
                    <td align="center" valign="top" style="padding: 40px 10px 40px 10px;">
                        <a href="<?=$this->Url->build('/',true)?>" target="_blank">
                            <?php
                            if(isset($settings['system_logo']))
                                $src = $settings['system_logo'];
                            else
                                $src = $this->Url->build('/img/logo.png',true);
                            ?>
                            <img alt="Logo" src="<?=$src?>" style="display: block; height: 70px; font-family: 'Lato', Helvetica, Arial, sans-serif; color: #ffffff; font-size: 18px;" border="0">
                        </a>
                    </td>
                </tr>
            </table>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;" >
                ...
                <tr>
                    <td bgcolor="#B3E5FC" align="center" style="padding: 30px 30px 30px 30px; border-radius: 4px 4px 4px 4px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;" >
                        ...
                        <p style="margin: 0;"><a href="http://litmus.com" target="_blank" style="color: #539be2;">We&rsquo;re here, ready to talk</a></p>
                    </td>
                </tr>
            </table>
            <!--[if (gte mso 9)|(IE)]>
