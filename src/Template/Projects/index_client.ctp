        ...
        <div class="card">
            <div class="card-block">
                        ...
                        <div class="border-bottom p-b-10">
                            <div class="row">
                                <div class="input-group col-sm-5 m-b-5">
                                    <button class="btn btn-default prepend-button"><i class="fa fa-clock-o"></i> Status</button>
                                    <?php
                $status=array(
                    '0'=>'Active',
                    '1'=>'Completed',
                ...
                echo $this->Form->select('status',
                    $status,
                    ['value' => $this->request->getQuery('status'),'class'=>'form-control','empty' => 'CHOOSE ONE','required'=>'true']
                );
                ?>
                                </div>
                                <div class="col-sm-2">
