...
$companymembers = $ctpdata['companymembers'];
                            ...
                            <div class="border-bottom p-b-10">
                                <div class="row">
                                    <div class="input-group col-sm-3 m-b-5">
                                        <button class="btn btn-default prepend-button border-right-radius-0 btn-sm"><i class="fa fa-clock-o"></i> Range</button>
                                    ...
                                    <div class="input-group col-sm-3 m-b-5">
                                        <button class="btn btn-default prepend-button border-right-radius-0 btn-sm"><i class="fa fa-user-o"></i> Members</button>
                                        <?php  echo $this->Form->select('member',
                                            $companymembers,
                                            ['value' => $this->request->getQuery('member'),'class'=>'form-control input-sm','empty' => 'All Members']
                                        );
                                        ?>
                                    </div>
                                    <div class="input-group col-sm-4 m-b-5">
                                        <button class="btn btn-default prepend-button border-right-radius-0 btn-sm"><i class="fa fa-tasks" aria-hidden="true"></i> Project</button>
