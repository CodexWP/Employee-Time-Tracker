                ...
                <div class="row m-b-20">
                    <div class="col-sm-12">
                        <div class="border-bottom p-b-10">
                            <div class="row">
                                <h3 class="text-themecolor col-sm-6"><i class="fa fa-user" aria-hidden="true"></i> All Clients</h3>
                                <div class="col-sm-6 text-right">
                                    <a href="<?=$this->Url->build('/clients/add')?>"><button class="btn btn-primary"><i class="fa fa-user-plus" aria-hidden="true"></i> Add Member</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <table class="table table-bordered users">
                            ...
                            if($sn==0)
                                echo '<tr><td colspan="6" class="text-center">There are no clients.</td></tr>';
                            ?>
                            </tbody>
                        </table>
                    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <?= $this->Form->hidden('type',['required'=>'true','value'=>'client']);?>
